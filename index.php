...
<body>
	...
	<header>
		...
		<nav>
			<ul>
				<li><a href="index.html" class="selected">Inicial</a></li>
	...
	<section class="main clearfix">
		<div class="work">
			<a href="inner.html">
				<img src="img/barcos.jpg" class="media" alt=""/>
				<div class="caption">
					<div class="work_title">
						<h1>Barcos Regionais</h1>
						<p>Esta peça conta com uma gama de caracteristicas que devem ser observadas com olhares precisos por seus admiradores.</p>
					</div>
				</div>
			</a>
		</div>
